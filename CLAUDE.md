...
**Next: Tier 2 — operational resilience** (CI gates `tsc`/`lint`, tests on the money paths, Sentry + structured logging). Self-contained handoff at `docs/agent-prompts/tier-2-operational-resilience-2026-05-31.md`.
