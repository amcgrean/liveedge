...
// GET /api/admin/jobs?search=&customer=&gps=all|matched|unmatched&branch=&status=&sort=newest|oldest|expect_date&page=1
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const orderBy = sort === 'oldest'      ? sql`soh.so_id ASC`
