...
import { CheckCircle2, Clock3, Sigma, TableProperties, Edit2, Plus } from 'lucide-react';
...
export function RegistryDashboard({ isAdmin }: Props) {
    ...
    if (loading) {
        return <div className="p-12 text-center text-slate-500">Loading registry configuration...</div>;
    }
