  ...
  return [
    ...
    },
    {
      ...
      links: [
        ...
        { href: '/admin/hubbell',       label: 'Hubbell',          sectionBefore: 'Vendor Reconciliation', requiresCap: ['hubbell.review'] },
      ],
    },
    {
      id: 'management',
...
const ADMIN_LINKS: AdminLink[] = [
  ...
  { href: '/admin/hubbell',       label: 'Hubbell',                                       requiresCap: ['hubbell.review'] },
