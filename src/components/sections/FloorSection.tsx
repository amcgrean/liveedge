...
import { FloorSection } from '../../types/estimate';
...
const DECK_TYPES = ['Edge T&G', 'Gold Edge', 'Advantech', 'Diamond'];
    ...
    return (
        <SectionCard title={`${sectionNumber}. ${title}`}>
            <div className="space-y-6">
                {/* Deck */}
                <div>
                    <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Deck</h3>
