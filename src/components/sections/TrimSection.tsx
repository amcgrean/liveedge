...
export function TrimSectionComp({ data, onChange }: Props) {
    ...
    const handleDoorCount = (field: keyof TrimSection['doorCounts'], value: string) => {
        onChange({
            ...data,
            doorCounts: { ...data.doorCounts, [field]: parseInt(value) || 0 }
        });
    };

    return (
        <SectionCard title="9. Trim">
            <div className="space-y-6">
                {/* Trim types */}
                <div>
                    <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Trim Types</h3>
                ...
                {/* Door counts */}
                <div>
                    <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Door Counts</h3>
                ...
                {/* Windows */}
                <div>
                    <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Windows</h3>
                ...
                {/* Handrail */}
                <div>
                    <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Handrail</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <InputGroup label="Handrail Type">
                            <select name="handrailType" value={data.handrailType} onChange={handleChange} className="input-field">
                                <option value="">Select handrail type...</option>
